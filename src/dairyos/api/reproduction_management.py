...
def _management(records):
    ...
    pregnancy_checks = [r for r in recent if str(r.event_type).lower() in {"pregnancy_check", "pregnancy-check", "pregnancy"}]
    confirmed = [
    ...
    return {
        ...
        "conception_rate_percent": round((len(confirmed) / len(inseminations)) * 100, 2) if inseminations else None,
