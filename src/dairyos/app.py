...
# The registration router owns POST /farm/animals so the permanent Animal ID
# is always generated by DairyOS. The legacy management router remains
# available for GET/PATCH/sub-resource operations.
