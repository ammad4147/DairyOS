...
# Registration owns POST /farm/animals so the permanent Animal ID is always
# generated by DairyOS. The management router remains available for reads,
# updates and sub-resources.
