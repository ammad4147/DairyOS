...
class OperationsCommandCenterOrchestrator:
    ...
    The orchestrator consumes the already-composed operational
    command-center service and adds the higher-level management,
    governance, accountability, control, and intelligence
    projections.
    """
    ...
    def __init__(
        ...
        if runtime is None:
            raise ValueError(
                "OperationsCommandCenterOrchestrator requires an ApplicationRuntime."
            )
