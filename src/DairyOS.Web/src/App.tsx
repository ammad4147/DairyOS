...
import { clearAuth, getStoredUser, hasPermission, saveUser, AuthUser } from './auth';
...
export default function MainAppShell(){
 ...
 if(!navItems.some(tab=>tab.id===currentView)&&currentView!=='settings'&&currentView!=='audit')setCurrentView(navItems[0]?.id||'dashboard');
