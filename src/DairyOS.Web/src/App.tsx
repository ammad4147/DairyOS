...
const entryConfigs: Record<
    string,
    OperationalEntryConfig
> = {
    milk: {
        endpoint: "/farm/milk",
        title: "Record Milk Production",
        description:
            "Enter the yield for an individual animal and milking session.",
        fields: [
            animalField,
            {
    ...
    finance: {
        ...
        description:
            "Capture operational income, expense, payment and animal-attributed financial transactions.",
        fields: [
            animalField,
            {
...
const navigation: NavigationItem[] = [
    {
        ...
        description:
            "Operational information and actionable farm notifications",
    },
    {
        id: "animals",
        label: "Herd Management",
        description:
            "Complete animal profiles, lifecycle and herd management",
    ...
    },
    {
        ...
        description:
            "Animal-linked milk recording, analytics and production intelligence",
        endpoint: "/farm/milk",
        mode: "entries",
    ...
    },
    {
        ...
        label: "Feed",
        description:
            "Feeding activity and quantities",
        endpoint: "/farm/feed",
        mode: "entries",
    ...
    },
    {
        ...
        description:
            "Animal health, vaccination, reminders and treatment history",
        endpoint: "/farm/health-observations",
        mode: "entries",
    ...
    },
    {
        ...
        label: "Breeding",
        description:
            "Reproduction events and reproductive history",
        endpoint: "/farm/breeding",
        mode: "entries",
    ...
    },
    {
        ...
        label: "Workforce",
        description:
            "Workforce activity and accountability",
        endpoint: "/farm/workforce",
        mode: "entries",
    ...
    },
    {
        ...
        label: "Inventory",
        description:
            "Stock movements and consumption",
        endpoint: "/farm/inventory",
        mode: "entries",
    ...
    },
    {
        ...
        label: "Analytics",
        description:
            "Production and operating indicators",
    ...
    },
    {
        ...
        description:
            "Operational decisions requiring attention",
        endpoint: "/dashboard",
...
function App() {
    ...
    const [farmStatus, setFarmStatus] =
        useState("CHECKING");
    ...
    const openAnimal = (animalId: string) => {
        ...
        setView("animal-passport");
        setMobileNavOpen(false);
    };

    const backFromPassport = () => {
                        ...
                        <>
                            ...
                            {view === "command" ? (
                                ...
                                <OperationalModule
                                    ...
                                    selector={
                                        activeNavigation.selector
                                    }
                                    mode={
                                        activeNavigation.mode
                                        ?? "state"
                                    }
                                    entry={
