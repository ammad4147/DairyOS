...
type HerdAnimal={id:string;breed:string;category:string;status:string};type Props={onSaveSale?:(liters:number)=>void;onUpdateReceivables?:(amount:number)=>void;herdMasterList?:HerdAnimal[];onAnimalChanged?:()=>void|Promise<void>};
...
export default function FinanceTab({onSaveSale,onUpdateReceivables,herdMasterList=[],onAnimalChanged}:Props={}){
 ...
 if(isAnimalSale){try{await onAnimalChanged?.()}catch{}}
