...
export default function SettingsTab({
  ...
  const [activeTab, setActiveTab] = useState<'FARM' | 'SYSTEM' | 'EMAIL' | 'DATA' | 'REPORTING' | 'IDENTITY'>('FARM');
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,minmax(0,1fr))', gap: 12, alignItems: 'start' }}>
            ...
            <section style={card}>
              ...
              <div style={{ color: '#64748b', fontSize: 9, marginTop: 8 }}>
                DairyOS automatically follows this computer's Windows local
                date, time, and timezone. No separate DairyOS timezone setting
                is required.
              </div>
            </section>
