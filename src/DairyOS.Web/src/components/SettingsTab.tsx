...
import { Building, Mail, Save, Sliders } from 'lucide-react';
...
export default function SettingsTab({ onFarmProfileUpdate }: SettingsTabProps) {
  const [activeTab, setActiveTab] = useState<'FARM' | 'STANDARDS' | 'EMAIL'>('FARM');
  ...
  useEffect(() => { if (activeTab === 'EMAIL') void loadEmail(); }, [activeTab]);
