...
partition_nodes() {
  case "$TARGET_DEVICE" in
    /dev/nvme*|/dev/mmcblk*)
      EFI_PART="${TARGET_DEVICE}p1"; BIOS_PART="${TARGET_DEVICE}p2"; ROOT_PART="${TARGET_DEVICE}p3"; LOG_PART="${TARGET_DEVICE}p4"; SWAP_PART="${TARGET_DEVICE}p5"; DATA_PART="${TARGET_DEVICE}p6" ;;
    *)
      EFI_PART="${TARGET_DEVICE}1"; BIOS_PART="${TARGET_DEVICE}2"; ROOT_PART="${TARGET_DEVICE}3"; LOG_PART="${TARGET_DEVICE}4"; SWAP_PART="${TARGET_DEVICE}5"; DATA_PART="${TARGET_DEVICE}6" ;;
  esac
}
